...
num_samples=$1
discrim_model="ntparse_pos_pretrained_0_2_32_128_16_128-pid6846.params"
gen_model="ntparse_gen_D0.3_2_256_256_16_256-pid4187.params"
num_sentences=1700 # dev

samples=expts/dev_pos_embeddings_s=${num_samples}.samples
...
build/nt-parser/nt-parser --cnn-mem 1700 -x -T corpora/train.oracle -p corpora/dev.oracle -C corpora/dev.stripped --pretrained_dim 300 -w embeddings/GoogleNews-ptb_filtered-vectors-negative300.txt -P --lstm_input_dim 128 --hidden_dim 128 -m $discrim_model --alpha 0.8 -s $num_samples > $samples
