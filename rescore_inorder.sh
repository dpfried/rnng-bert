...
basename="${decodes_oracle%.inorder.oracle}"

decodes_and_scores=${basename}.inorder.unindexed_scores
decodes_bracketed=${basename}.inorder.bracketed
decodes_and_scores_reindexed=${basename}.inorder.scores
